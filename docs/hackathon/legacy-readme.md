# Historical README — superseded September 21, 2026

This is retained development history, not the current product or verification status. Use the root README and current submission package. Links below retain their original locations and may be relative to the repository root.
