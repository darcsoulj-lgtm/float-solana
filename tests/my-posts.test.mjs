...
void test('My posts query isolates ownership, excludes deleted posts and preserves pagination', async () => {
  ...
  try {
    db.exec(`CREATE TABLE community_members(id TEXT,alias TEXT);
      CREATE TABLE community_threads(id TEXT,member_id TEXT,topic TEXT,title TEXT,body TEXT,created_at INTEGER,hidden INTEGER);
      ...
      INSERT INTO community_threads VALUES ('a','alice','general','A','Body',10,0),('b','bob','general','B','Body',20,0),('hidden','alice','general','Hidden','Body',30,1);`);
